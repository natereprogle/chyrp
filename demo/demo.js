...
(function () {
  ...
  (function () {
    ...
    setInterval(
      tick,
      DISPLAY_MS + Math.max(TRANSITION_MS, WIDTH_TRANSITION_MS) + TRANSITION_MS
    );
  })();
  ...
  bind("icon-svg", function () {
    ...
    path.setAttribute(
      "d",
      "M12 2 L15 9 L22 9 L17 14 L19 22 L12 18 L5 22 L7 14 L2 9 L9 9 Z"
    );
  ...
  var sections = Array.prototype.slice.call(
    document.querySelectorAll("main .docsec[id]")
  );
